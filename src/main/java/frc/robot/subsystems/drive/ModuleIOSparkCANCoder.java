...
/**
 * Module IO implementation using Spark MAX for both drive and turn motors,
 * and a CTRE CANCoder for the turn angle.
 */
public class ModuleIOSparkCANCoder implements ModuleIO {
    ...
    public ModuleIOSparkCANCoder(int module, int turnEncoderCanId) {
        ...
        cancoderConfig.MagnetSensor.SensorDirection = turnEncoderInverted ? 
        ...
        turnPositionQueue = SparkOdometryThread.getInstance().registerSignal(turnSpark, () -> turnCANCoder.getAbsolutePosition().getValueAsDouble());
    }
    ...
    private void configureDriveMotor() {
        ...
        tryUntilOk(driveSpark, 5, () -> driveSpark.configure(driveConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters));
    ...
    private void configureTurnMotor() {
        ...
        turnConfig.absoluteEncoder.inverted(turnEncoderInverted)
                  ...
                  .averageDepth(2);
        turnConfig.closedLoop.feedbackSensor(com.revrobotics.spark.FeedbackSensor.kAbsoluteEncoder)
                  .positionWrappingEnabled(true)
                  .positionWrappingInputRange(turnPIDMinInput, turnPIDMaxInput)
                  .pid(turnKp, 0.0, turnKd);
        tryUntilOk(turnSpark, 5, () -> turnSpark.configure(turnConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters));
    }
    ...
    public void updateInputs(ModuleIOInputs inputs) {
        ...
        ifOk(driveSpark, new DoubleSupplier[]{driveSpark::getAppliedOutput, driveSpark::getBusVoltage}, 
        ...
        inputs.turnPosition = Rotation2d.fromRotations(turnCANCoder.getAbsolutePosition().getValueAsDouble());
        ...
        inputs.odometryTurnPositions = turnPositionQueue.stream()
                .map(d -> Rotation2d.fromRotations(d))
